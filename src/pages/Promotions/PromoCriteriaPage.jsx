            ...
            <div className="overflow-x-auto min-h-[400px]">
              <table className="w-full text-sm text-left whitespace-nowrap">
                <thead className="bg-slate-50/80 dark:bg-slate-800/80 text-slate-500 dark:text-slate-400 sticky top-0 backdrop-blur-sm z-10 border-b border-slate-200 dark:border-slate-700">
                  <tr>
                    <th className="px-6 py-4 font-semibold uppercase tracking-wider text-[11px]">{activeTab === 'types' ? 'Type Code' : 'Value Code'}</th>
            ...
            >
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
                <h3 className="text-lg font-bold text-slate-800 dark:text-white flex items-center gap-2">
                  ...
                  {editingId ? `Edit Criteria ${activeTab === 'types' ? 'Type' : 'Value'}` : `Add Criteria ${activeTab === 'types' ? 'Type' : 'Value'}`}
                </h3>
                <button
                  onClick={handleCloseModal}
              ...
              <div className="p-6">
                <form id="criteriaForm" onSubmit={handleSave} className="space-y-5">
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1.5 uppercase tracking-wider">{activeTab === 'types' ? 'Type Code' : 'Value Code'} <span className="text-red-500">*</span></label>
                    <input
                      type="text"
                      name="code"
                      required
                      ...
                      placeholder={activeTab === 'types' ? "e.g. 01" : "e.g. V001"}
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
                <h3 className="text-sm font-bold text-slate-800 dark:text-white flex items-center gap-2">
                  ...
                  {activeTab === 'types' ? 'Type' : 'Value'} Details
                </h3>
                <button
                  onClick={handleCloseDetailModal}
