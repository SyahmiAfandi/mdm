...
import {
  Search, Plus, Save, X, Edit2, AlertCircle, CalendarClock, Trash2, Info
} from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-slate-50/50 dark:bg-slate-900/50">
      <div className="shrink-0 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Promo Period Config</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400">Define valid date ranges and periods for promotions.</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 w-full sm:w-64 bg-slate-100 dark:bg-slate-800/50 border-none rounded-xl text-sm focus:ring-2 focus:ring-amber-500 dark:focus:ring-amber-400 transition-all"
            />
          </div>
          {canEdit && (
            <button
